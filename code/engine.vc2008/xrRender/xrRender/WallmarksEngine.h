...
private:
	void				BuildMatrix				(Matrix4x4 &dest, float invsz, const Fvector& from);
	void				RecurseTri				(u32 T,	Matrix4x4 &mView, static_wallmark	&W);
...
public:
	...
	void				AddSkeletonWallmark		(const Matrix4x4* xf, CKinematics* obj, ref_shader& sh, const Fvector& start, const Fvector& dir, float size);
