...
protected:
	...
	virtual void			_FillVerticesHW1W	(const Matrix4x4& view, CSkeletonWallmark& wm, const Fvector& normal, float size, Fvisual* V, u16* indices, CBoneData::FacesVec& faces);
	virtual void			_FillVerticesHW2W	(const Matrix4x4& view, CSkeletonWallmark& wm, const Fvector& normal, float size, Fvisual* V, u16* indices, CBoneData::FacesVec& faces);
	virtual void			_FillVerticesHW3W	(const Matrix4x4& view, CSkeletonWallmark& wm, const Fvector& normal, float size, Fvisual* V, u16* indices, CBoneData::FacesVec& faces);
	virtual void			_FillVerticesHW4W	(const Matrix4x4& view, CSkeletonWallmark& wm, const Fvector& normal, float size, Fvisual* V, u16* indices, CBoneData::FacesVec& faces);
	virtual void			_FillVertices		(const Matrix4x4& view, CSkeletonWallmark& wm, const Fvector& normal, float size, Fvisual* V, u16 bone_id, u32 iBase, u32 iCount);
...
public:
	...
	virtual void			FillVertices	(const Matrix4x4& view, CSkeletonWallmark& wm, const Fvector& normal, float size, u16 bone_id);
private:
